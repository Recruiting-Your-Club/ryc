...
public record AllClubGetResponse(
    ...
    @Schema(description = "동아리 간단 설명") @NotBlank(message = "club short description shouldn't be blank")
    ...
    @Schema(description = "동아리 태그 리스트") @NotNull(message = "club tag shouldn't be null") List<ClubTag> clubTags) {}
