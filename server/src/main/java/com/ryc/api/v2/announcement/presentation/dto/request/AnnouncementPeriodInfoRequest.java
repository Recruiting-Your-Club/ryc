...
public record AnnouncementPeriodInfoRequest(
    @NotNull(message = "applicationPeriod shouldn't be null") PeriodRequest applicationPeriod,
    @Schema(description = "면접 기간") PeriodRequest interviewPeriod,
    @Schema(description = "서류 결과 발표 기간") PeriodRequest documentResultPeriod,
    @NotNull(message = "finalResultPeriod shouldn't be null") PeriodRequest finalResultPeriod) {}
