...
public class Admin {
    ...
    @Builder.Default
    private final AdminDefaultRole adminDefaultRole = AdminDefaultRole.USER;

    @Builder.Default
    private final Boolean deleted = Boolean.FALSE;

    // TODO: 해당 메소드를 사용하는 경우는 register시 클라이언트에게 받은 값을 Domain으로 변환시에만 사용된다. 따라서, 파라미터로 해당 requestDTO 고려
    public static Admin initialize(String name, String email, String password, String imageUrl, String thumbnailUrl){
