...
public class ApplicationForm {
   ...
   * @throws
   */
  private void validatePersonalInfoQuestionTypes(List<ErrorCode> errors) {
    ...
    if (!providedTypes.containsAll(requiredTypes)) {
      errors.add(AnnouncementErrorCode.MISSING_REQUIRED_PERSONAL_INFO);
    }
  }
}
