...
export const rootContainer = css `
    ...
    min-width: 50rem;
`;
export const toolbarContainer = (radius = '4px') => css `
    width: 100%;
    height: 40px;
...
export const perButtonCss = css `
    ...
    background-color: transparent;
`;
export const svgCss = (isColor) => css `
    height: 60%;
    ...
    `}
`;
export const textColorSvgCss = (isColor, selectedColor) => css `
    height: 60%;
    color: ${theme.colors.black};
    align-items: center;
    justify-content: center;
    ...
    `}
`;
export const textareaContainer = (height = '350px', radius = '4px') => css `
    width: 100%;
    height: ${height};
    overflow-y: auto;
    resize: none;
...
export const pickerContainer = css `
    ...
    z-index: 30;
`;
export const perColorCss = (color, text) => css `
    width: 16px;
    height: 16px;
